...
import twitter_credentials_bot
import time
...
class TwitterAuthenticator:
    ...
    def authenticate_twitter_app():
        ...
        """
        auth = OAuthHandler(twitter_credentials_bot.CONSUMER_KEY, twitter_credentials_bot.CONSUMER_KEY_SECRET)
        auth.set_access_token(twitter_credentials_bot.ACCESS_TOKEN, twitter_credentials_bot.ACCESS_TOKEN_SECRET)
        return auth
...
class HandlePost:
    ...
    @staticmethod
    def post_opener_tweet(message):
        auth = TwitterAuthenticator.authenticate_twitter_app()
        tweet_poster = API(auth)
        tweet_poster.update_status(message)
    ...
    def post_comment(status_id, message):
        ...
        print(status_id)
        comment_post.update_status('@roylccp ' + message, status_id)
